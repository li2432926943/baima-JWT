...
<template>
    <div style="height: 160px" v-loading="!data.success"
        ...
        <div style="display: grid;grid-template-columns: repeat(5, 1fr);text-align: center" v-if="data.hourly && data.hourly.length">
            <div v-for="(item, index) in data.hourly" :key="index">
